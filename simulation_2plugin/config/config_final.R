...
# ── 메서드 순서 ───────────────────────────────────────────────────────────────
# 최종 병합 비교 방법론 목록 (IBOSS, non-param with RF 추가)
METHOD_ORDER <- c("FULL", "SRS", "LEV-IPW", "IBOSS", "OPT-homo", "OPT-hetero-oracle", "OPT-hetero-plugin-param", "OPT-hetero-plugin-nonparam")


RF_MTRY_FIXED     <- 1L
RF_NODESIZE_FIXED <- 2L