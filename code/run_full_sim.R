# run_full_sim.R
# Full simulation (4/29 확정 설계)
# Cases: 1, 2, 3 / k: 200, 500, 1000, 2000 / N = 10000 / n0 = 200 / reps = 300
...
# 저장
saveRDS(sim_results, "results/full_sim_results.rds")
write.csv(sim_results, "results/full_sim_results.csv", row.names = FALSE)
 
cat("Done. Total rows:", nrow(sim_results), "\n")
# 예상 행 수: 3 cases × 4 k × 300 reps × 7 methods = 25,200