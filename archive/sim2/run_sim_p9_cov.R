# run_sim_p9_cov.R
# Step 4-2: p=9 Mixed Covariate + Low-dimensional Variance, 
# aligned low-dimensional variance
#
# Purpose:
...
cat("====================================================\n")
cat(" p=9 Mixed Covariate simulation (Step 4-2)\n")
...
saveRDS(results_df, "sim/results_p9_mixed.rds")
cat(sprintf("\n저장 완료: sim/results_p9_mixed.rds (%d행)\n", nrow(results_df)))
